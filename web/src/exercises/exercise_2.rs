...
pub fn exercise_2(gl: &RenderContext, cm1: &mut WebGlTexture, cm2: &mut WebGlTexture) {
    ...
    let cm_context1 = UniformContext::new_from_allocated_ref(&cm1, "u_palette_1", 256, 1);
    let cm_context2 = UniformContext::new_from_allocated_ref(&cm2, "u_palette_2", 256, 1);
